...
set(_expectedTargets IPOPT::ipopt)
...
set(IPOPT_VERSION "3.12.5")

add_library(IPOPT::ipopt STATIC IMPORTED)
set_target_properties(IPOPT::ipopt PROPERTIES
  IMPORTED_LOCATION "${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/lib/libipopt.a"
  INTERFACE_INCLUDE_DIRECTORIES "${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/include/ipopt"
)
